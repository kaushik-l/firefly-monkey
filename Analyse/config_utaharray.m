function ops = config_utaharray(fname,fpath,useGPU)
...
ops.fbinary             = fullfile(fpath, [fname '.dat']); % will be created for 'openEphys'
...
ops.Nfilt               = 384;  % number of clusters to use (2-4 times more than Nchan, should be a multiple of 32)     		
...
ops.lam              = [20 60 60];   % large means amplitudes are forced around the mean ([10 30 30])		
