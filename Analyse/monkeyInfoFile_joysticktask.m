...
% monkeyInfo (end).coord.depth = 5365;     % Depth below gray matter (in microns)
...
% monkeyInfo (end).coord.depth = 4572;
% monkeyInfo (end).channels = 1:24;
% monkeyInfo (end).units = 0;
...
% monkeyInfo (end).coord.depth = 6231;
% monkeyInfo (end).channels = 1:24;
% monkeyInfo (end).units = 0;
...
% monkeyInfo (end).coord.depth = 5673;
% monkeyInfo (end).channels = 1:24;
% monkeyInfo (end).units = 0;
...
% monkeyInfo (end).coord.column = 17;
% monkeyInfo (end).coord.depth = 10800;
% monkeyInfo (end).channels = 1:24;
% monkeyInfo (end).units = 0;
...
% monkeyInfo (end).coord.row = -4;
% monkeyInfo (end).coord.column = 17;
% monkeyInfo (end).coord.depth = 6100;
% monkeyInfo (end).channels = 1:24;
% monkeyInfo (end).units = 0;
...
% monkeyInfo (end).coord.column = 12;
% monkeyInfo (end).coord.depth = 5900;
% monkeyInfo (end).channels = 1:24;
% monkeyInfo (end).units = 0;
...
% monkeyInfo (end).coord.column = 14;
% monkeyInfo (end).coord.depth = 5776;
% monkeyInfo (end).channels = 1:24;
% monkeyInfo (end).units = 0;
...
% monkeyInfo (end).coord.depth = 7809;
% monkeyInfo (end).channels = 1:24;
% monkeyInfo (end).units = 0;
...
% monkeyInfo (end).coord.row = -6;
% monkeyInfo (end).coord.column = 16;
% monkeyInfo (end).coord.depth = 11212;
...
% monkeyInfo (end).coord.depth = 7342;
% monkeyInfo (end).channels = 1:24;
% monkeyInfo (end).units = 0;
...
% monkeyInfo (end).coord.depth = 12855;
% monkeyInfo (end).channels = 1:24;
% monkeyInfo (end).units = 0;
...
% monkeyInfo (end).coord.row = -5;
% monkeyInfo (end).coord.column = 14;
% monkeyInfo (end).coord.depth = 5540;
% monkeyInfo (end).channels = 1:24;
% monkeyInfo (end).units = 0;
...
% monkeyInfo (end).coord.row = -6;
% monkeyInfo (end).coord.column = 18;
% monkeyInfo (end).coord.depth = 3723;
% monkeyInfo (end).channels = 1:24;
% monkeyInfo (end).units = 0;
...
% monkeyInfo (end).coord.column = 16;
% monkeyInfo (end).coord.depth = 5455;
% monkeyInfo (end).channels = 1:24;
% monkeyInfo (end).units = 0;
...
% monkeyInfo (end).coord.depth = 6347;
% monkeyInfo (end).channels = 1:24;
% monkeyInfo (end).units = 0;
...
% monkeyInfo (end).coord.row = -4;
% monkeyInfo (end).coord.column = 20;
% monkeyInfo (end).coord.depth = 7734;
% monkeyInfo (end).channels = 1:24;
% monkeyInfo (end).units = 0;
...
% monkeyInfo (end).coord.depth = 5873;
% monkeyInfo (end).channels = 1:24;
% monkeyInfo (end).units = 0;
...
% monkeyInfo (end).coord.row = -6;
% monkeyInfo (end).coord.column = 15;
% monkeyInfo (end).coord.depth = 7133;
% monkeyInfo (end).channels = 1:24;
% monkeyInfo (end).units = 0;
...
% monkeyInfo (end).coord.row = -2;
% monkeyInfo (end).coord.column = 18;
% monkeyInfo (end).coord.depth = 5370;
% monkeyInfo (end).channels = 1:24;
% monkeyInfo (end).units = 0;
...
% monkeyInfo (end).coord.depth = 7502;
% monkeyInfo (end).channels = 1:24;
% monkeyInfo (end).units = 0;
...
% monkeyInfo (end).coord.row = -8;
% monkeyInfo (end).coord.column = 18;
% monkeyInfo (end).coord.depth = 7273;
% monkeyInfo (end).channels = 1:24;
% monkeyInfo (end).units = 0;
...
% monkeyInfo (end).coord.row = -7;
% monkeyInfo (end).coord.column = 15;
% monkeyInfo (end).coord.depth = 9932;
% monkeyInfo (end).channels = 1:24;
% monkeyInfo (end).units = 0;
...
% monkeyInfo (end).coord.row = -1;
% monkeyInfo (end).coord.column = 20;
% monkeyInfo (end).coord.depth = 6490;
% monkeyInfo (end).channels = 1:24;
% monkeyInfo (end).units = 0;
...
% monkeyInfo (end).coord.depth = 11935;
% monkeyInfo (end).channels = 1:24;
% monkeyInfo (end).units = 0;
...
% monkeyInfo (end).coord.depth = 7692;
% monkeyInfo (end).channels = 1:24;
% monkeyInfo (end).units = 0;
...
% monkeyInfo (end).coord.row = -7;
% monkeyInfo (end).coord.column = 16;
% monkeyInfo (end).coord.depth = 10033;
% monkeyInfo (end).channels = 1:16;
% monkeyInfo (end).units = 0;
...
% monkeyInfo (end).coord.depth = 9478;
% monkeyInfo (end).channels = 1:16;
% monkeyInfo (end).units = 0;
...
% monkeyInfo (end).coord.row = -5;
% monkeyInfo (end).coord.column = 21;
% monkeyInfo (end).coord.depth = 9042;
% monkeyInfo (end).channels = 1:16;
% monkeyInfo (end).units = 0;
...
% monkeyInfo (end).coord.row = -8;
% monkeyInfo (end).coord.column = 19;
% monkeyInfo (end).coord.depth = 8979;
% monkeyInfo (end).channels = 1:16;
% monkeyInfo (end).units = 0;
...
% monkeyInfo (end).coord.row = -1;
% monkeyInfo (end).coord.column = 21;
% monkeyInfo (end).coord.depth = 8732;
% monkeyInfo (end).channels = 1:24;
% monkeyInfo (end).units = 0;
...
% monkeyInfo (end).coord.depth = 10487;
% monkeyInfo (end).channels = 1:24;
% monkeyInfo (end).units = 0;
...
% monkeyInfo (end).coord.row = -7;
% monkeyInfo (end).coord.column = 17;
% monkeyInfo (end).coord.depth = 7880;
% monkeyInfo (end).channels = 1:24;
% monkeyInfo (end).units = 0;
...
% monkeyInfo (end).coord.row = -4;
% monkeyInfo (end).coord.column = 17;
% monkeyInfo (end).coord.depth = 10553;
% monkeyInfo (end).channels = 1:24;
% monkeyInfo (end).units = 0;
...
% monkeyInfo (end).coord.row = -2;
% monkeyInfo (end).coord.column = 22;
% monkeyInfo (end).coord.depth = 8650;
% monkeyInfo (end).channels = 1:24;
% monkeyInfo (end).units = 0;
...
% monkeyInfo (end).coord.row = -6;
% monkeyInfo (end).coord.column = 18;
% monkeyInfo (end).coord.depth = 8177;
% monkeyInfo (end).channels = 1:24;
% monkeyInfo (end).units = 0;
...
% monkeyInfo (end).coord.row = -5;
% monkeyInfo (end).coord.column = 14;
% monkeyInfo (end).coord.depth = 10468;
% monkeyInfo (end).channels = 1:16;
% monkeyInfo (end).units = 0;
...
monkeyInfo (end).channels = 1:96;
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Quigley\Utah array\August 1 2017';
monkeyInfo (end).comments = {'two densities, no landmarks, no perturbations; juice - 150ms & 300ms; ' ...
