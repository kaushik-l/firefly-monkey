...
if any(strcmp(prs.electrode_type,'linearprobe24'))
        ...
        if length(this.behaviours.trials)==length(events_plx.t_end)
            ...
            for j=1:prs.maxchannels_plx
                ...
                if n == fn
                    ...
                    this.lfps(end+1) = lfp(channel_id,electrode_id(ch_id == channel_id),prs.electrode_type,prs.brain_area,prs.coord);
