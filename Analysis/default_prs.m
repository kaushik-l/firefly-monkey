...
prs.filepath_behv =  ['W:\Data\Monkey_discovery\' monkeyInfo.folder '\behavioural data\'];  % ['/Users/eavilao/Documents/Temp_data/firefly-monkey-data/' monkeyInfo.folder '/behavioural data/']; % 
...
prs.eye_distr = true; % plot eye vel distribution for all trials in a session.
