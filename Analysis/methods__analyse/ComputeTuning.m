...
elseif strcmp(tuning_method,'k-nearest')
    ...
    nbins = tuning_prs.nbins1d_binning; % load predefined number of bins
    [tuningstats.tuning.stim,tuningstats.tuning.rate] = NPregress_knn(xt,yt,temporal_binwidth,k,nbins,nbootstraps,tuning_binrange);
elseif strcmp(tuning_method,'nadaraya-watson')
    ...
    [tuningstats.tuning.stim,tuningstats.tuning.rate] = NPregress_nw(xt,yt,temporal_binwidth,kernel,bandwidth,[],nbootstraps,tuning_binrange);
elseif strcmp(tuning_method,'local-linear')
    ...
    [tuningstats.tuning.stim,tuningstats.tuning.rate] = NPregress_locallinear(xt,yt,temporal_binwidth,kernel,bandwidth,[],nbootstraps,tuning_binrange);
end